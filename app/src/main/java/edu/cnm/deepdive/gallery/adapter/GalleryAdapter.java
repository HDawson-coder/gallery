...
public class GalleryAdapter extends RecyclerView.Adapter<Holder> {
  ...
  public GalleryAdapter(
      Context context, List<Gallery> galleries, OnGalleryClickHelper onGalleryClickHelper) {
  ...
  class Holder extends RecyclerView.ViewHolder implements OnClickListener {
    ...
    //inner class to prepare the views to be created.
    ...
    private void bind(int position) { //loading the galleries with title, and description
    ...
    public void onClick(View view) {
      onGalleryClickHelper.onGalleryClick(
          galleries.get(getAdapterPosition()).getId().toString(), view);
    }
  }
